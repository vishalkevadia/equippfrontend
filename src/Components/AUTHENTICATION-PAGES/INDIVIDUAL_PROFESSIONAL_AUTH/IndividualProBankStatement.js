...
import '../../../App.css'
import bankstat from '../STUDENT_AUTH/Images/bankstat.png'
import rightarrow from '../STUDENT_AUTH/Images/rightarrow.png'
import plusIcon from '../STUDENT_AUTH/Images/+.png'
import CheckoutNav from '../../CHECKOUT/CheckoutNav'




const IndividualProBankStatement = () => {
  return (
    <>
...
export default IndividualProBankStatement;